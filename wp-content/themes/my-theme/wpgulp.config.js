...
module.exports = {
	...
	// Project options.
	projectURL: 'http://localhost/wpstarter/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// JS options.
	jsSRC: ['./js/lib/*.js','./js/page/*.js','./js/common.js'], // Path to JS vendor folder.
	jsDestination: './js/', // Path to place the compiled JS vendors file.
	jsFile: 'all', // Compiled JS vendors file name. Default set to vendors i.e. vendors.js.
	...
	watchJs: ['./js/lib/*.js','./js/page/*.js','./js/common.js'], // Path to all vendor JS files.
	// watchJsCustom: './js/page/*.js', // Path to all custom JS files.
